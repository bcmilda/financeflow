...
function renderSmsImport() {
  ...
  el.innerHTML = `
    <div class="card" style="margin-bottom:12px">
      <div style="font-weight:600;font-size:.88rem;margin-bottom:6px;display:flex;align-items:center;gap:8px">📱 Vložit notifikaci z banky
        <span style="font-size:.6rem;background:rgba(251,191,36,.2);color:var(--debt);padding:1px 6px;border-radius:4px;font-weight:700;letter-spacing:.03em">BETA</span>
      </div>
      <div style="font-size:.72rem;color:var(--debt);background:rgba(251,191,36,.08);border:1px solid rgba(251,191,36,.2);border-radius:8px;padding:8px 10px;margin-bottom:10px;line-height:1.45">
        ⚠️ Zatím <strong>ruční</strong> – text notifikace musíš zkopírovat a vložit. Automatické čtení notifikací z jiných aplikací prohlížeč neumožňuje (řešením by byla nativní Android appka).
      </div>

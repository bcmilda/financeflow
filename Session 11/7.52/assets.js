...
function renderAssets() {
  ...
  el.innerHTML = `
    ...
    ${D.assets.length ? [...D.assets].sort((a,b)=>(b.value||0)-(a.value||0)).map(a => assetBuildCard(a, ASSET_TYPES[a.type]||ASSET_TYPES.custom)).join('') : `
      <div class="empty" style="padding:32px">
        <div class="ei">📦</div>
        <div class="et">Zatím žádná aktiva</div>

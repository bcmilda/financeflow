...
PRAVIDLO 2 – VÁHOVÉ položky (kg, g): lineTotal = PRAVÝ sloupec účtenky = celková zaplacená cena, price = cena/kg:
- "Klobása Lucifer  0,180 kg  269,90 Kč/kg  48,58 Kč" → price:269.90, qty:0.180, unit:"kg", lineTotal:48.58
- "Meloun vodní  6,445 kg × 19,90 Kč/kg  128,26 Kč" → price:19.90, qty:6.445, unit:"kg", lineTotal:128.26
KLÍČOVÉ: u váhových položek lineTotal ≠ price × qty! lineTotal = skutečná zaplacená částka.

PRAVIDLO 3 – SLEVY: lineTotal = cena PO slevě (číslo v závorce nebo za SLEVA).
- "Paprika 0,458kg × 99,99  45,75 SLEVA -13,74 (32,01)" → lineTotal:32.01

...
{"store":"název obchodu","date":"YYYY-MM-DD nebo null","total":číslo,"currency":"CZK","items":[{"name":"název","price":CENA_ZA_KUS_NEBO_SKUTECNA_CENA,"qty":množství}],"category":"Jídlo & Nákupy nebo Drogerie nebo Elektronika nebo Restaurace nebo Benzín nebo Jiné"}

!!! KRITICKÁ PRAVIDLA !!!

PRAVIDLO 1 – "price" = VŽDY skutečná zaplacená cena za JEDEN KUS/JEDNOTKU (ne cena za kg):
- "Rohlík 43g  6ks × 2,90 Kč/ks  17,40 Kč" → price:2.90, qty:6
- "Mléko 1l  1ks  29,90 Kč" → price:29.90, qty:1
- "Banán v čokoládě 45g  2ks × 12,90 Kč  25,80 Kč" → price:12.90, qty:2

PRAVIDLO 2 – VÁHOVÉ položky (kg, g): price = SKUTEČNÁ ZAPLACENÁ CENA (poslední číslo na řádku), qty = hmotnost:
- "Klobása Lucifer  0,180 kg  269,90 Kč/kg  48,58 Kč" → price:48.58, qty:0.180
- "Banán  1,798 kg × 39,90 Kč/kg  71,74 Kč  SLEVA -26,97  (44,77)" → price:44.77, qty:1.798  [SLEVA = skutečná cena]
- "Paprika červená  0,458 kg × 99,99 Kč/kg  45,75 Kč  SLEVA -13,74  (32,01)" → price:32.01, qty:0.458

PRAVIDLO 3 – SLEVY: pokud je ke položce SLEVA nebo slevová cena v závorce, použij SLEVOVOU cenu jako price.

PRAVIDLO 4 – "total" = CELKOVÁ ZAPLACENÁ ČÁSTKA (řádek "Celkem" nebo "Součet" nebo "TOTAL"). Pokud chybí, spočítej sum(price × qty).

PRAVIDLO 5 – Nezahrnuj do items: záhlaví, daňové řádky (DPH, 21%), platební způsoby, věrnostní body, čárové kódy.`
              }
            ]
          }]
        };

...
function drawHealthScoreLineChart(canvasId, months) {
  ...
  // (dle náčrtu uživatele). Vyšší skóre = kruh výš. Výška dle počtu bodů.
  ...
  const padL = ringR + 12, padR = ringR + 12, padT = ringR + 14, padB = 30;
  const plotW = W - padL - padR, plotH = H - padT - padB;

  // jemné horizontální gridlines (0/25/50/75/100)

// FinanceFlow · v9.08 · premium.js · 2026-07-21
//  PREMIUM SYSTEM
// ══════════════════════════════════════════════════════
...
function processAutoSablony() {
  ...
  S.sablony.filter(s=>s.auto).forEach(s=>{
    ...
    // S17.8 (FIX-210 v3, Milan): výskyt TOHOTO měsíce se doplní i když den splatnosti teprve
    // přijde (proaktivně), aby byl hned vidět. Řeší i případ „datum před dneškem" (splatnost už
    // nastala). Tedy: vždy doplň chybějící výskyt aktuálního měsíce (v mezích endDate).

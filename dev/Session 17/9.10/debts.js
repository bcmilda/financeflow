//  FinanceFlow · v9.10 · debts.js · 2026-07-23
//  ADD / EDIT TX
// ══════════════════════════════════════════════════════
function openAddTx(){
  ...
  el.innerHTML=`<div class="reality-card">
    ...
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:8px;margin-bottom:12px">
      <div class="reality-metric">
        <div class="reality-big" style="font-size:clamp(1rem,5vw,1.7rem);line-height:1.15;overflow-wrap:anywhere;color:var(--expense)">${fmtB(overpay)}</div>
        <div class="reality-lbl">přeplatíte celkem na úrocích</div>
      </div>
      <div class="reality-metric">
        <div class="reality-big" style="font-size:clamp(1rem,5vw,1.7rem);line-height:1.15;overflow-wrap:anywhere;color:var(--debt)">${dailyCost} Kč</div>
        <div class="reality-lbl">stojí vás dluh každý den</div>
      </div>
      <div class="reality-metric">
        <div class="reality-big" style="font-size:clamp(1rem,5vw,1.7rem);line-height:1.15;overflow-wrap:anywhere;color:var(--expense)">${years>0?years+'r ':''} ${months}m</div>
        <div class="reality-lbl">ještě budete splácet</div>
      </div>
      <div class="reality-metric">
        <div class="reality-big" style="font-size:clamp(1rem,5vw,1.7rem);line-height:1.15;overflow-wrap:anywhere;color:var(--debt)">${incomePct}%</div>
    ...
    <div class="hourly-cost-card" onclick="openFutureSim()" style="margin-bottom:10px">
      ...
      <div style="display:flex;align-items:baseline;justify-content:center;gap:8px;flex-wrap:wrap">
        <div class="hourly-big" style="font-size:clamp(1.6rem,9vw,3rem);line-height:1.1">${Math.round(totalInterest/Math.max(1,maxMonths*30*24))} Kč</div>
...
function renderDebtStressWidget(D) {
  ...
  el.innerHTML=`<div class="stress-card" style="background:${stressBg};border-color:${stressBorder}">
    ...
    <div style="display:flex;justify-content:space-between;font-size:.68rem;color:#a8aec8;margin-bottom:12px">

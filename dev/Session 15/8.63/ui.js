// FinanceFlow · v8.63 · ui.js · 2026-07-03
//  RENDER ROUTER
// ══════════════════════════════════════════════════════
...
function renderTx(){
  ...
  if(groupByDate) {
    ...
    dates.forEach(date => {
      ...
      // v8.58 (TODO-146): denní sumář v základní měně – 900 GBP už není 900 Kč
      const dayInc = dayTxs.filter(t=>t.type==='income').reduce((a,t)=>a+txCZK(t,D),0);

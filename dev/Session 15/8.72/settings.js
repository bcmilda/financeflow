// FinanceFlow · v8.72 · settings.js · 2026-07-06
// ══════════════════════════════════════════════════════
    ...
    <div class="settings-section">
      ...
      <div class="settings-item" style="flex-direction:column;align-items:stretch;gap:6px">
        ...
        <select class="fs" id="settingConvCur" style="margin-left:38px;width:calc(100% - 38px);box-sizing:border-box" onchange="settingChanged()">
          ...
          <option value="EUR" ${_settings?.convCur==='EUR'?'selected':''}>🇪🇺 EUR – Euro</option>
          <option value="USD" ${_settings?.convCur==='USD'?'selected':''}>🇺🇸 USD – Dolar</option>
          <option value="GBP" ${_settings?.convCur==='GBP'?'selected':''}>🇬🇧 GBP – Libra</option>
          <option value="PLN" ${_settings?.convCur==='PLN'?'selected':''}>🇵🇱 PLN – Zlotý</option>
          <option value="CHF" ${_settings?.convCur==='CHF'?'selected':''}>🇨🇭 CHF – Frank</option>
          <option value="HUF" ${_settings?.convCur==='HUF'?'selected':''}>🇭🇺 HUF – Forint</option>
        </select>

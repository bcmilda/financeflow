...
function renderRadarDailyChart(txs, monthInc, avgInc, avgExp, D){
  ...
  canvas._radarData = {daysInMonth, todayDay, cumolEnd, cumExp, dailyExp, incomeTarget, predEnd, incomeDay};
...
function drawRadarDaily(canvas, hoverDay){
  ...
  const {daysInMonth:days, todayDay, cumolEnd, cumExp, dailyExp, incomeTarget, predEnd, incomeDay}=d0;

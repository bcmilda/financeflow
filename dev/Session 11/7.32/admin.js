    ...
    <div id="atab-announce-content" style="display:none">
      <div class="card" style="margin-bottom:14px">
        ...
        <div class="card-body">
          ...
          <div class="fg"><label>Nadpis</label><input class="fi" id="annNewTitle" placeholder="např. Nová funkce: Spending Pace" maxlength="80"></div>
          ...
          <button class="btn btn-accent" onclick="addAnnouncement()" style="width:100%;font-weight:700">📢 Zveřejnit oznámení</button>
        </div>
      </div>
      <div class="card">
        <div class="card-header"><span class="card-title">📋 Zveřejněná oznámení</span><button class="btn btn-ghost btn-sm" onclick="loadAdminAnnouncements()">🔄</button></div>

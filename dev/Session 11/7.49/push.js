...
async function openNotifSettings() {
  ...
  m.innerHTML = `
    <div style="background:var(--surface);width:100%;max-width:520px;border-radius:20px 20px 0 0;padding:20px;max-height:86vh;overflow-y:auto" onclick="event.stopPropagation()">
      <div style="display:flex;align-items:center;margin-bottom:14px">
        <span style="font-size:1.15rem;font-weight:700;color:var(--text)">🔔 Nastavení oznámení</span>
        <button onclick="document.getElementById('notifSettingsModal').remove()" style="margin-left:auto;background:none;border:none;color:var(--text2);font-size:1.6rem;line-height:1;cursor:pointer">×</button>
      </div>
      <div onclick="notifSettingsTogglePush()" style="display:flex;align-items:center;gap:12px;padding:14px 2px;cursor:pointer;background:var(--surface2);border-radius:12px;margin-bottom:8px">
      ...
      <div style="font-size:.72rem;color:var(--text3);text-transform:uppercase;letter-spacing:.05em;margin:14px 0 2px">Co chceš dostávat</div>
      ...
      <div style="font-size:.7rem;color:var(--text3);margin-top:14px;text-align:center;line-height:1.5">Vypnuté typy ti nebudou chodit jako push.<br>Zprávy najdeš vždy v 📢 Oznámení.</div>
    </div>`;

...
function renderImport() {
  ...
  el.innerHTML = `
    ...
    <div id="itab-pdf-content" style="display:none">
      <div class="card" style="margin-bottom:14px">
        <div class="card-header"><span class="card-title">📄 Import z PDF výpisu</span><span style="font-size:.72rem;color:var(--text3)">${(window._currentUser && !window._isLocalMode) ? '📄 Max ~200 transakcí na soubor' : '🔒 Pro import z PDF se přihlas'}</span></div>
        <div class="card-body">
          <div style="font-size:.8rem;color:var(--text2);margin-bottom:14px">

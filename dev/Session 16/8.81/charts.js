// FinanceFlow · v8.81 · charts.js · 2026-07-08
//  GRAFY (simplified)
// ══════════════════════════════════════════════════════
...
function renderKumulChart(days, cumul, medVal, m, y, allTxs) {
  ...
  const cumulOf=(mm,yy)=>{
    ...
    (allTxs||[]).forEach(t=>{ if(t.type!=='expense')return; const d=new Date(t.date); if(d.getMonth()!==mm||d.getFullYear()!==yy)return; const di=d.getDate()-1; if(di>=0&&di<dd) arr[di]+=t.amount||t.amt||0; });

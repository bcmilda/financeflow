// FinanceFlow · v8.92 · admin.js · 2026-07-13
//  ADMIN PANEL
// ══════════════════════════════════════════════════════
        ...
        <div style="background:var(--surface2);border-radius:10px;padding:12px;margin-bottom:14px">
          ...
          ${(()=>{
            ...
            return `<div style="margin-top:12px;padding-top:12px;border-top:1px solid var(--border)">
              ...
              <div style="display:flex;justify-content:space-between;font-size:.66rem;color:var(--text3);margin-top:4px">
...
async function loadCommunityActivity() {
  ...
  try {
    ...
    el.innerHTML = `
      ...
      ${topUsers}
      <div style="font-size:.66rem;color:var(--text3);margin-top:12px;line-height:1.4">⚠️ Náklady jsou odhad (tokeny × cena Sonnet × kurz). Tracking funguje jen když má worker nastavené secrets FIREBASE_SERVICE_ACCOUNT + FIREBASE_DB_URL.</div>
    `;
  } catch(e) {

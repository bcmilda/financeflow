...
// ══════════════════════════════════════════════════════
// ══════════════════════════════════════════════════════
// FINANČNÍ SKÓRE (Dashboard) – computeFinancialScore()
// Rozsah: 0–100 bodů | Zobrazuje: Dashboard widget "Finanční skóre"
// Srovnává: aktuální měsíc vs předchozí 2 měsíce (trend)
//
// POZNÁMKA K ARCHITEKTUŘE TŘÍ SYSTÉMŮ (ADR-042, Session 8):
// V aplikaci existují 3 RŮZNÉ hodnotící systémy pro finanční zdraví.
// Záměrně měří různé věci, ale uživatele to může mást:
//
// 1. computeFinancialScore() [premium.js] → "Finanční skóre" (0-100)
//    Měří: Zdraví aktuálního měsíce (příjmy vs výdaje, zadlužení, úspory, trend)
//    Kdy je kritické: výdaje > příjmy = okamžitá 0 v složce 1
//
// 2. computeHealthScores() [projects.js] → "Finanční zdraví" v Souhrnu výdajů
//    Měří: Zdraví kategorií (dodržování limitů, úspory), měsíční snapshot
//    Kdy je kritické: výdaje > příjmy v poměru, kategorie překračují limity
//
// 3. renderObraz() [projects.js] → "Finanční obraz" trend 6 měsíců
//    Měří: Směr pohybu (zlepšuji/stagnuji/zhoršuji) za 6 měsíců
//    Kdy je stagnace: první měsíc s daty === poslední (po FIX-077 opraveno)
//
// Systém 1 MŮŽE říkat "Kritické" zatímco Systém 3 říká "Stagnuji" protože:
// - Systém 1: výdaje 41k > příjmy 32k → 0 bodů za složku 1 = nutně kritické
// - Systém 3: únor byl 70k příjmy, duben 32k → pokles → ale výpočet závisí na baseline
// ══════════════════════════════════════════════════════

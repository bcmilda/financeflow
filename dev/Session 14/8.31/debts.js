//  FinanceFlow · v8.31 · debts.js · 2026-06-24
//  ADD / EDIT TX
// ══════════════════════════════════════════════════════
function openAddTx(){
...
function saveTx(){
  ...
  if(curTxType==='transfer'){
    ...
    if(_transferMode==='assets'){
      ...
      const aTagsRaw=document.getElementById('txTags')?.value||'';const aTags=parseTags(aTagsRaw);if(aTags.length)aObj.tags=aTags;

// FinanceFlow · v8.28 · admin.js · 2026-06-24
//  ADMIN PANEL
// ══════════════════════════════════════════════════════
...
async function renderAdmin() {
  ...
  el.innerHTML = `
    ...
    <!-- S14: ÚDRŽBA DAT (vždy viditelné, nezávisle na záložce) -->
    <div class="card" style="margin-bottom:14px">
      <div class="card-header"><span class="card-title">🧰 Údržba dat</span></div>
      <div class="card-body">
        <div style="font-size:.78rem;color:#a8aec8;margin-bottom:10px;line-height:1.5">
          🔄 <strong>Migrace přesunových kategorií</strong> – převede tvoje kategorie <strong>Investice, Trading, Spoření</strong> na typ „Přesun" a doplní chybějící (<strong>Finanční rezerva, Fondy, Penzijko</strong>). Transakce v nich se přestanou počítat jako výdaj – přesunou se do „úspor a investic". Finanční úřad a Půjčka zůstanou beze změny. Spuštění je bezpečné i opakovaně.
        </div>
        <button class="btn btn-accent btn-sm" onclick="migrateTransferCategories()">🔄 Spustit migraci přesunových kategorií</button>
      </div>
    </div>

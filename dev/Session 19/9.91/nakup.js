// FinanceFlow · v9.91 · nakup.js · 2026-08-19
// ══════════════════════════════════════════════════════
...
function nakupBuildRow(item) {
  ...
  if (latestPrice) {
    priceHtml = `
      ...
      ${(catItem.latestStore||catItem.latestDate) ? `<div style="font-size:.66rem;color:#a8aec8">${catItem.latestStore||''}${catItem.latestStore&&catItem.latestDate?' · ':''}${catItem.latestDate?fmtD(catItem.latestDate):''}</div>` : ''}`;

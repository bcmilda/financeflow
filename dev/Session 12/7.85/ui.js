...
function buildTxRow(t, D, ro, dupMap={}) {
  ...
  // S12.1i: na mobilu tap na běžný řádek otevře editaci (split/účtenkové řádky mají vlastní akordeon)
  const mobileTapAttr = (!ro && !isSplitParent && !hasReceiptItems && window.innerWidth <= 820)
    ? `onclick="editTx('${t.id}')" style="cursor:pointer"` : '';

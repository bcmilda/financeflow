// FinanceFlow · v9.71 · projects.js · 2026-08-03
//  PROJEKTY
// ══════════════════════════════════════════════════════
    ...
    <div class="card" style="margin-bottom:12px">
      <div class="card-body" style="padding:14px">
        <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:3px">
          ...
          <span style="font-size:.62rem;color:var(--text3)">${series.length}M vs baseline</span>
        </div>
    ...
    <div class="card" style="margin-bottom:12px">
      <div class="card-body" style="padding:14px">
        <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:3px">
          ...
          <span style="font-size:.62rem;color:var(--text3)">aktuální stav</span>
        </div>
    ...
    <div class="card" style="margin-bottom:12px">
      <div class="card-body" style="padding:14px">
        <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:3px">
          ...
          <span style="font-size:.62rem;color:var(--text3)">aktuální měsíc</span>
        </div>
    ...
    <div class="card" style="margin-bottom:12px">
      <div class="card-body" style="padding:14px">
        <div style="display:flex;justify-content:space-between;align-items:baseline;margin-bottom:3px">
          ...
          <span style="font-size:.62rem;color:var(--text3)">${momentum.months}M průměr</span>
        </div>
        ...
        <div style="margin-top:11px;padding:10px 12px;background:var(--surface2);border-left:3px solid ${pos===series.length?'var(--income)':pos>=series.length/2?'var(--debt)':'var(--expense)'};border-radius:0 10px 10px 0">
          <div style="display:flex;justify-content:space-between;gap:8px;align-items:baseline">
            ...
            <span style="font-size:.62rem;color:var(--text3)">${series.length}M</span></div>
    ...
    <div class="card">
      ...
      <div class="card-body" style="padding:0">
        ...
        ${(()=>{ // v8.74: sumář období – součty + průměry
          ...
          return `<div style="display:grid;''' + G + ''';padding:9px 10px;border-top:2px solid var(--border2);font-size:.72rem;font-weight:700;background:var(--surface2)">
          ...
          <div style="display:grid;''' + G + ''';padding:6px 10px;font-size:.66rem;color:#a8aec8">
            <span>Ø/měs</span>
          ...
          <div style="display:grid;''' + G + ''';padding:7px 10px;font-size:.68rem;font-weight:700;border-top:1px solid var(--border)" title="Ø posledních 3 měsíců vs Ø předchozích 3 měsíců">

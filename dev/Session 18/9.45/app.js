// FinanceFlow · v9.45 · app.js · 2026-08-03
  ...
  try {
    ...
    try {
      const s = {transactions:S.transactions||[],debts:S.debts||[],categories:S.categories||[],
                 ...
                 assets:S.assets||[],shareSettings:S.shareSettings||{},calNotes:S.calNotes||{},workCal:S.workCal||{},diary:S.diary||{},idleCfg:S.idleCfg||{},milestones:S.milestones||[],_savedAt:Date.now()};
...
window.onUserSignedIn = async function(user) {
  ...
  _dbListener = _onValue(userRef, (snapshot) => {
    ...
    sanitizeUserData(S); // S16.5 (P0-1) + S17: normalizace tx object→array (onValue byl dřív vynechán)
    ...
    setSyncStatus('ok');
    if(typeof _dwSeed==='function') _dwSeed(); // S17: seed diff-write z čerstvého serverového stavu
...
// ══════════════════════════════════════════════════════
const _DW_META = ['debts','categories','bank','birthdays','wishes','wallets','payTypes','sablony','projects','receipts','nakupList','assets','noSyncKeys','importHistory','shareSettings','calNotes','workCal','diary','idleCfg','milestones'];

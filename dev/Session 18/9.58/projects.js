// FinanceFlow · v9.58 · projects.js · 2026-08-03
//  PROJEKTY
// ══════════════════════════════════════════════════════
        ...
        <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap">
          ...
          <div style="flex:1;min-width:190px">
            ...
            <div style="font-size:.72rem;color:#a8aec8;margin-top:5px">
              Kolik ze Základu příjmu (${fmt(scores.baseIncome)}) odkládáš do 📈 investic a 🛟 rezervy.
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div style="font-size:.72rem;color:#a8aec8;line-height:1.6;margin-top:10px;border-top:1px solid var(--border);padding-top:8px">
            ...
            <div><strong style="color:var(--text)">Úsporové</strong> – aktivní spoření (složka S4: % základu do 📈 investic + 🛟 rezervy, 0–35 b) na 0–100.</div>
          </div>

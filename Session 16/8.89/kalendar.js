// FinanceFlow · v8.89 · kalendar.js · 2026-07-12
// ══════════════════════════════════════════════════════
    ...
    html += `
      ...
      >
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:4px">
          ...
          ${hasTx ? `<span style="font-size:.66rem;color:var(--text3);background:rgba(255,255,255,.08);border-radius:4px;padding:1px 5px">${data.txs.length}</span>` : ''}
        </div>

// FinanceFlow · v8.94 · admin.js · 2026-07-13
//  ADMIN PANEL
// ══════════════════════════════════════════════════════
        ...
        const rows = groups.map(g => {
          ...
          return `<div style="padding:10px 0;border-bottom:1px solid var(--border)">
            ...
            <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
              <span style="font-size:.64rem;color:#a8aec8;min-width:52px">ČSÚ průměr</span>
              ...
              <span style="font-size:.68rem;color:#a8aec8;min-width:48px;text-align:right">${fmt(csuAmt)} Kč</span>
            </div>
            ${myAmt>0?`<div style="display:flex;align-items:center;gap:6px">
              <span style="font-size:.64rem;color:#a8aec8;min-width:52px">Vy</span>
              <div style="flex:1;height:6px;background:var(--surface3);border-radius:3px;overflow:hidden">
            ...
            </div>`:'<div style="font-size:.68rem;color:#a8aec8;padding-left:60px">žádné výdaje</div>'}
          </div>`;
        }).join('');

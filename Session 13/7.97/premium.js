...
async function startTrial() {
  ...
  try {
    // Kontrola 1: už tento UID trial využil?
    ...
    // Kontrola 2: už tento e-mail trial využil (přes jiný UID / Google + email)?
    if (eKey) {
    ...
    // Zaznamenej e-mail do globálního registru (blokuje opakování přes jiný UID)
    if (eKey) {

...
## DOPLNEK: v8.25 - v8.27 (presuny, frekvence vyplaty, napojeni na dashboard)

### features.md

#### Typ kategorie Presun (v8.25)
Novy typ kategorie transfer vedle Prijem/Vydaj/Oboji. Transakce v transfer-kategoriich se NEPOCITAJI jako vydaj (nesnizi majetek), ale penezenka se upravi. Ukazuji kolik penez smeruje na investice/rezervu/sporeni. Vychozi: Investice, Trading, Financni rezerva, Sporeni, Fondy, Penzijko. Stare redundantni odstraneny. V Oboji zustavaji Financni urad + Pujcka. isTransferTx rozsiren o detekci kategorii type:transfer (window._transferCatIds Set).

#### Frekvence vyplaty + Runway per frekvence (v8.26)
Nastaveni (vedle Den vyplaty): frekvence vyplaty - mesicne / 14denne / tydne / 2x mesicne / nepravidelne. Runway respektuje frekvenci. Nepravidelny rezim: cyklus od posledni prijmove transakce do pristi podle prumerneho odstupu prijmu. Tydenni/14denni krokuje o 7/14 dni. 2x mesicne pocita 2 vyplaty. Tabulka tydnu cyklu se prizpusobi delce.

#### Napojeni presunu na dashboard (v8.27, faze 2)
Nova dashboard karta Moje uspory a investice - kolik penez smeruje do Investic a Rezervy/Sporeni (kumulativne + tento mesic) + rozpad podle kategorie. Hodnoty z computeTransferTotals: vydaj=vklad, prijem=vyber, net=vklady minus vybery. Nemutuje data.

### decisions.md

#### ADR-073 - Hodnoty presunu pocitany, ne mutovany (v8.27)
Presuny do investic/rezervy se NEzapisuji do S.assets jako mutace pri kazde transakci (riziko nekonzistence, double-count, sync pri mazani). Misto toho computeTransferTotals spocita hodnoty z transakci za behu. Vzdy konzistentni, smazani transakce hodnotu prepocita. Propsani do realnych S.assets mozne v dalsi fazi.

#### ADR-074 - Frekvence vyplaty zobecnuje Runway (v8.26)
radarPaydayInfo rozsireno z mesicniho cyklu na obecny podle _settings.payFreq. Nepravidelny rezim pracuje s realnymi prijmy, pravidelne krokuji o pevny pocet dni. Prepinac zvolen misto nove zalozky.

### todo.md

#### TODO-143 - Tabulky a grafy investic/sporeni v case (open)
Faze 3 presunu: vyvoj hodnoty investic/rezervy v case (graf), rozpad po mesicich, pripadne propsani do realnych zaznamu S.assets.

#### TODO-141 - VYRESENO (v8.25)
Kategorie typu presun implementovana. Sporeni/investice se uz nepocitaji jako vydaj.

---

*Doplnek Session 13: v8.25-v8.27 | ADR-073-074, TODO-143*

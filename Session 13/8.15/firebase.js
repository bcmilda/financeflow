...
onAuthStateChanged(auth, async (user) => {
  if (user) {
    ...
    // FIX (S13): vyčisti veškerý stav PŘED zrušením _currentUser (odpojí listenery na vlastní uzel,
    // vynuluje S/partnerData/viewingUid) – zabrání úniku dat při střídání uživatelů na zařízení.
    try { if (typeof resetAppState === 'function') resetAppState(); } catch(e) {}

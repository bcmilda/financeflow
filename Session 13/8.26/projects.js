// FinanceFlow · v8.26 · projects.js · 2026-06-20
//  PROJEKTY
// ══════════════════════════════════════════════════════
      ...
      <div class="card-body">
        ...
        ${(() => {
          ...
          <div style="font-size:.66rem;color:var(--text3);margin-top:8px;padding:8px 10px;background:var(--surface3);border-radius:8px;line-height:1.5">
            <strong style="color:var(--text2)">Výpočet:</strong> Cashflow = Příjem − Plánovaný výdej − Budoucí platby = ${fmt(income)} − ${fmt(planned)} − ${fmt(future)} = <strong style="color:${cashflow>=0?'var(--income)':'var(--expense)'}">${cashflow>=0?'':'−'}${fmt(Math.abs(cashflow))} Kč</strong><br>

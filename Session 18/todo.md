...
> **Aktualizováno 2026-08-03 (audit S18).** Předchozí verze tabulky byla z éry Session 9 a tvrdila ~67 otevřených úkolů — neodpovídala skutečnosti. Audit křížově porovnal `todo.md` proti `VERZE_LOG` (298 verzí) a proti skutečnému kódu. **59 úkolů uzavřeno** jako prokazatelně hotových, u každého je pod nadpisem uveden důkaz v kódu. Detail: `AUDIT_todo_bugs_s18.md`.

| Priorita | Otevřené | Příklady |
|---|---|---|
| 🔴 P1 | 3 | TODO-177 diff-write fáze 2 · TODO-193 Report (taby + PDF) · TODO-198 Měsíční review fáze 2–4 |
| 🟡 P2 | ~16 | TODO-182 Bank 12M · TODO-187 čerpání hypotéky · TODO-190 auto-materializace · TODO-192 sjednocení opakování · TODO-196 názvy položek · TODO-199 Checkout Session · TODO-138/139/140 limity · TODO-145/146 měny |
| 🟢 P3 | ~10 | TODO-189 účtenková služba · TODO-179 push digest · TODO-180 Capacitor · TODO-027 Google Play (čeká na SHA-256) · TODO-028 lokalizace |
| ⚠️ Ověřit | 4 | TODO-068/069/070/076 Bubble chart — kód žije v `ui.js` (3 varianty), nutná vizuální kontrola; zavřelo by i OPEN-027/028/031 |
| 🗑 Kandidáti na zrušení | 13 | Sekce B auditu — **zatím NEZAVŘENO**, Milan chce ověřit jednotlivě |

**Celkem reálně otevřených:** ~33 (bylo 94)

**Session 18 (v9.43):** TODO-200 ✅ obloukový ukazatel skóre · TODO-201 🆕 portfolio ceny (ADR-098) · audit todo/bugs · landing page texty (čeká na screenshoty)
...
### TODO-002 · ~~Integrace offline transakcí do `app.js`~~ ✅ DOKONČENO (audit S18) **(Session 4 TODO-02 → Session 6 update)**
> Důkaz v kódu (2026-08-03): `offline-sync.js` (celý modul)
...
### TODO-084 · ~~Cena/kg a cena/l tracking~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `receipts.js` + `inflace.js` (S17)
...
### TODO-085 · ~~Shrinkflation detektor~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `receipts.js` + `inflace.js` (S17)
...
### TODO-088 · ~~Financial Freedom Ratio (FFR)~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `helpers.js`, `projects.js`
...
### TODO-089 · ~~Inflace životního stylu~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `projects.js`
...
### TODO-090 · ~~Asset Allocation vizualizace~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟢 P3)**
> Důkaz v kódu (2026-08-03): `assets.js`
...
### TODO-091 · ~~Income Diversification Score~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟢 P3)**
> Důkaz v kódu (2026-08-03): `projects.js`
...
### TODO-092 · ~~Wealth Momentum~~ ✅ DOKONČENO (audit S18) **(Session 9, 🟢 P3)**
> Důkaz v kódu (2026-08-03): `projects.js` — S16 TODO-171
...
### TODO-007 · ~~Monitoring chyb – Sentry **(Session 4 TODO-04)** ⚠️ NASAZENO S6 – OVĚŘIT~~ ✅ DOKONČENO (audit S18)
> Důkaz v kódu (2026-08-03): Sentry v `app.html`, `firebase.js`, `app.js`
...
### TODO-009 · ~~Box plot přesun~~ ✅ DOKONČENO (audit S18) **(Session 3 P2)**
> Důkaz v kódu (2026-08-03): `charts.js`
- **Soubor:** `charts.js`
...
### TODO-010 · ~~Webová landing page~~ ✅ DOKONČENO (audit S18) **(Session 3 P2)**
> Důkaz v kódu (2026-08-03): běží na financeflow.cz
...
### TODO-011 · ~~Predikce – ověřit modré hodnoty pro minulé měsíce~~ ✅ DOKONČENO (audit S18) **(Session 3 P2)**
> Důkaz v kódu (2026-08-03): `predictCat`, `computeYearForecast`
...
### TODO-012 · ~~Nové kategorie z xlsx souboru~~ ✅ DOKONČENO (audit S18) **(Session 2 Vysoká)**
> Důkaz v kódu (2026-08-03): `categories.json`
...
### TODO-013 · ~~Kontrola duplikátů v záložce Transakce~~ ✅ DOKONČENO (audit S18) **(Session 2 Vysoká)**
> Důkaz v kódu (2026-08-03): `duplicates.js` (celý modul)
...
### TODO-014 · ~~AI pamatuje mapování kategorií~~ ✅ DOKONČENO (audit S18) **(Session 2 Střední)**
> Důkaz v kódu (2026-08-03): `categoryMappings` (app.js, ai.js, import.js)
...
### TODO-015 · ~~Notifikace opakovaných plateb~~ ✅ DOKONČENO (audit S18) **(Session 2 Střední)**
> Důkaz v kódu (2026-08-03): `budouci.js`
...
### TODO-017 · ~~Příspěvky zaměstnavatele – kategorie~~ ✅ DOKONČENO (audit S18) **(Session 2 Střední)**
> Důkaz v kódu (2026-08-03): `categories.json`
- Penzijko, Edenred benefit
- Typ: `income`, `stable: false`

### TODO-018 · ~~Hlídání cen produktů~~ ✅ DOKONČENO (audit S18) **(Session 2 Vysoká – přeřazeno)**
> Důkaz v kódu (2026-08-03): hlídání cen v `push.js`, `projects.js`
...
### TODO-047 · ~~Nákupní seznam – průzkum a dokumentace funkce~~ ✅ DOKONČENO (audit S18) **(konsolidace 2026-04-16)**
> Důkaz v kódu (2026-08-03): splněno praxí (viz překryv K)
- **Soubor:** `nakup.js`
...
### TODO-048 · ~~COICOP – úprava a vylepšení~~ ✅ DOKONČENO (audit S18) **(konsolidace 2026-04-16)**
> Důkaz v kódu (2026-08-03): `coicopSubclassTotals`, `coicop.js`
...
### TODO-075 · ~~AI Rate Limiting – implementace ADR-041~~ ✅ DOKONČENO (audit S18) **(Session 8, 🔴 P1)**
> Důkaz v kódu (2026-08-03): `AI_LIMITS` + `aiUsage` aktivní ve `worker.js`
...
### TODO-072 · ~~Finanční kategorie příjmů – váhy a stable flag~~ ✅ DOKONČENO (audit S18) **(Session 8, 🟡 P2)**
> Důkaz v kódu (2026-08-03): stable flag napříč 6 moduly
...
### TODO-073 · ~~Donate / Stripe – Premium subscription~~ ✅ DOKONČENO (audit S18) **(Session 8, 🟡 P2)**
> Důkaz v kódu (2026-08-03): Stripe LIVE (S17)
...
### TODO-077 · ~~Krátkodobý pohled ve Finančním obrazu~~ ✅ DOKONČENO (audit S18) **(Session 8, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `projects.js`
...
### TODO-019 · ~~Service Worker pro plný offline~~ ✅ DOKONČENO (audit S18) **(Session 4 TODO-07)**
> Důkaz v kódu (2026-08-03): `sw.js`, cache `ff-shell-v9.43`
...
### TODO-021 · ~~Komprese fotek v `analyzeMultiReceipt` offline větvi~~ ✅ DOKONČENO (audit S18) **(Session 4 TODO-09)**
> Důkaz v kódu (2026-08-03): komprese v `receipts.js`
...
### TODO-022 · ~~Platební systém 💰~~ ✅ DOKONČENO (audit S18) **(Konflikt mezi sessions)**
> Důkaz v kódu (2026-08-03): Stripe LIVE (S17) — konflikt GoPay/Stripe rozhodnut
...
### TODO-023 · ~~Admin panel – správa členství~~ ✅ DOKONČENO (audit S18) **(Session 1 P1)**
> Důkaz v kódu (2026-08-03): `admin.js` — premiumLog, banUser, setPremium
...
### TODO-029 · ~~Podpora více měn~~ ✅ DOKONČENO (audit S18) **(S1 P4 / S2 Nízká / S3 P3)**
> Důkaz v kódu (2026-08-03): `baseCur/baseRate/czkToBase` v `helpers.js`
- EUR, USD, GBP při importu
- Kurzy z ČNB API nebo ECB
- Nastavitelné směnné kurzy
- Konverze v reportech

### TODO-030 · ~~Web Push notifikace~~ ✅ DOKONČENO (audit S18) **(S1 P4 / S2 Vysoká / S3 P3)**
> Důkaz v kódu (2026-08-03): `push.js`, `worker-push.js`
...
### TODO-031 · ~~Export CSV / PDF / XLSX report~~ ✅ DOKONČENO (audit S18) **(S1 P4 / S2 Střední / S3 P3)**
> Důkaz v kódu (2026-08-03): Nastavení → Záloha dat (JSON), `settings.js`
Sjednoceno na P3:
...
### TODO-033 · ~~Automatická pravidla (auto-kategorizace)~~ ✅ DOKONČENO (audit S18) **(Session 3 P3)**
> Důkaz v kódu (2026-08-03): keyword engine v `import.js`, `product-db.js`
- „Shell" → Doprava/Benzín, „Albert" → Jídlo/Supermarket
- UI pro správu pravidel v nastavení

### TODO-034 · ~~Komunita – průměry výdajů~~ ✅ DOKONČENO (audit S18) **(S2 Nápady / S3 P3)**
> Důkaz v kódu (2026-08-03): `community/` uzly, Srovnání ČR
...
### TODO-036 · ~~Přesunout COICOP / Srovnání ČR do vlastní sekce~~ ✅ DOKONČENO (audit S18) **(Session 1 P3)**
> Důkaz v kódu (2026-08-03): `coicop.js` (vlastní modul)
- Aktuálně v záložkách Analýzy účtenek
- Zaslouží si vlastní stránku: `page-coicop`

### TODO-037 · ~~Podkategorie v grafech~~ ✅ DOKONČENO (audit S18) **(Session 1 P3)**
> Důkaz v kódu (2026-08-03): `charts.js`
- Souhrn výdajů a Měsíční report zobrazují jen kategorie, ne podkategorie
- Drill-down kliknutím na kategorii

### TODO-038 · ~~Porovnání cen mezi obchody~~ ✅ DOKONČENO (audit S18) **(Session 1 P3)**
> Důkaz v kódu (2026-08-03): `inflace.js` — multifiltr obchodů, `normalizeStoreName` (S17)
- Záložka „Obchody" v analýze účtenek
- Kde je který produkt nejlevnější

### TODO-039 · ~~Split transakce – automatický z účtenky~~ ✅ DOKONČENO (audit S18) **(Session 1 P2)**
> Důkaz v kódu (2026-08-03): `splitParent` napříč 16 moduly
...
### TODO-061 · ~~Chord diagram – propojení kategorií~~ ✅ DOKONČENO (audit S18) **(Session 7.0, 🟢 P3)**
> Důkaz v kódu (2026-08-03): `stats.js`
...
### TODO-062 · ~~Treemap v záložce 12M reportu~~ ✅ DOKONČENO (audit S18) **(Session 7.0, 🟢 P3)**
> Důkaz v kódu (2026-08-03): `ui.js` — bubbleTreemapWrap
...
### TODO-040 · ~~Vlastní doména~~ ✅ DOKONČENO (audit S18) **(Session 2 Střední – posunuto na P4)**
> Důkaz v kódu (2026-08-03): financeflow.cz běží
- Místo `financeflow-a249c.web.app`
- Potřeba pro Google Play a Privacy Policy URL

### TODO-041 · ~~Světlý/tmavý motiv~~ ✅ DOKONČENO (audit S18) **(Session 1 P4)**
> Důkaz v kódu (2026-08-03): `settings.js`, `ff_theme`
- **Stav:** ✅ Částečně hotovo (existuje `applyTheme()`), ale viz `bugs.md` OPEN-020 (Auto téma)

### TODO-042 · ~~Více měn v jedné peněžence + auto kurz~~ ✅ DOKONČENO (audit S18) **(Session 1 P4)**
> Důkaz v kódu (2026-08-03): `kurzy.js` + ČNB endpoint
- Různé peněženky v různých měnách
- Automatický kurz z ECB API
- **Souvisí s TODO-029** (globální podpora měn)

### TODO-043 · ~~Sdílení přehledu – read-only link bez přihlášení~~ ✅ DOKONČENO (audit S18) **(Session 1 P4)**
> Důkaz v kódu (2026-08-03): `share.js`
...
### TODO-046 · ~~Offline mode – explicitní indikátor~~ ✅ DOKONČENO (audit S18) **(S1 P2 / S2 Nízká)**
> Důkaz v kódu (2026-08-03): `app.js`
...
### TODO-094 · ~~ČSÚ data na úrovni skupin a tříd~~ ✅ DOKONČENO (audit S18) **(Session 10, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `coicop.js`
...
### TODO-095 · ~~Mapování vlastních kategorií na COICOP 1:1~~ ✅ DOKONČENO (audit S18) **(Session 10, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `admin.js`
...
### TODO-097 · ~~Stripe Payment Links + Premium zámky~~ ✅ DOKONČENO (audit S18) **(Session 10, 🔴 P1)**
> Důkaz v kódu (2026-08-03): Stripe Payment Links LIVE (S17)
...
### TODO-098 · ~~Lineární trend predikce + IQR outliery~~ ✅ DOKONČENO (audit S18) **(Session 10, 🟡 P2)**
> Důkaz v kódu (2026-08-03): `charts.js` — IQR, lineární trend
- **Popis:** Vylepšení predikce nad klouzavý průměr × sezóna. ADR-052.
- **Stav:** 📋 Návrh, k implementaci.

### TODO-099 · ~~Spending Pace – druhý měsíc dat~~ ✅ DOKONČENO (audit S18) **(Session 10, 🟢 P3)**
> Důkaz v kódu (2026-08-03): „Tempo výdajů" (S16 TODO-168)
- **Popis:** Graf Spending Pace hotov (v7.31), plný efekt až s 2+ měsíci historie.
- **Stav:** ✅ Graf hotov, čeká na data.

### TODO-062 · ~~Treemap v 12M reportu~~ ✅ DOKONČENO (audit S18) **(aktualizace stavu Session 10)**
> Důkaz v kódu (2026-08-03): `ui.js` — bubbleTreemapWrap
...
### TODO-117 · ~~Slevy z účtenek → propojení s Nákupním seznamem 🟡 P2~~ ✅ DOKONČENO (audit S18) **(Session 11)**
> Důkaz v kódu (2026-08-03): `nakup.js`
...
### TODO-119 · ~~Push notifikace na mobil 🔴 P1~~ ✅ DOKONČENO (audit S18) **(Session 11)**
> Důkaz v kódu (2026-08-03): `push.js`
...
### TODO-121 · ~~GDPR Cookie Consent Mode pro GA4 🟢 P3~~ ✅ DOKONČENO (audit S18) **(Session 11)**
> Důkaz v kódu (2026-08-03): `app.html`, `index.html`
...
### TODO-093 (update) · ~~Anti-flicker _dataSig + render architektura~~ ✅ DOKONČENO (audit S18) **(Session 11)**
> Důkaz v kódu (2026-08-03): `_dataSig` v `app.js`, `ui.js`
...
### TODO-142 - ~~Plna telemetrie aktivity (open)~~ ✅ DOKONČENO (audit S18)
> Důkaz v kódu (2026-08-03): `admin.js`
...
### TODO-075 - ~~AI Rate Limiting aktivace (kod hotovy, pending secrets)~~ ✅ DOKONČENO (audit S18)
> Důkaz v kódu (2026-08-03): `AI_LIMITS` + `aiUsage` aktivní ve `worker.js`
...
### TODO-147 · ~~Graf pod tabulkou Zdražování~~ ✅ DOKONČENO (audit S18) **(S14 otevřeno, 🟢 P3)**
> Důkaz v kódu (2026-08-03): `receipts.js` buildPricesTab
...
### TODO-153 · ~~Stripe webhook a Premium tier infrastruktura~~ ✅ DOKONČENO (audit S18) **(🟡 P2, STÁLE OTEVŘENO)**
> Důkaz v kódu (2026-08-03): Stripe webhook LIVE (S17)
...
### TODO-154 · ~~MacroDroid parser bankovních notifikací~~ ✅ DOKONČENO (audit S18) **(🟢 P3, odloženo)**
> Důkaz v kódu (2026-08-03): `sms-import.js`

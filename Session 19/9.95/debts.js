//  FinanceFlow · v9.95 · debts.js · 2026-08-19
//  ADD / EDIT TX
// ══════════════════════════════════════════════════════
function openAddTx(){
...
function saveTx(){
  ...
  if(_eCzk!=null){ txObj.amount=_eCzk; txObj.amt=_eCzk; txObj.amtCZK=null; txObj.currency=null; }
    ...
    if(txObj.currency){
      ...
      if(_prev && _prev.fxRef!=null && _prev.currency===txObj.currency){
        txObj.fxRef=_prev.fxRef; txObj.fxRefDate=_prev.fxRefDate||null;   // zachovej původní
      } else {

...
| `bank_statement_text` | **(Session 7.0)** Text extraction z PDF výpisů. `payload: {text, batchIndex, totalBatches}`, dávky 15 stránek | 8192 | S7.0 |
| `advisor_report` | **(Session 7.1)** AI finanční poradce ČR. Výstup: `JSON {recommendations:[{title,detail,saving}]}`, max 4 | 8192 | S7.1 |
...
| Soubor | Hash S4 (v6.44) | Hash S6 (v6.48) |
|--------|-----------------|-----------------|
| `app.js` | `109e73d4` | `ed1bcf97` ← Session 6 |
| `helpers.js` | `faccb6fa` | `e50f43f4` ← Session 6 |
| `ui.js` | `3134d203` | `3134d203` |
...
| `premium.js` | `bb2ce262` | *(přepočítat po nasazení)* ← Session 6 |
| `projects.js` | `db47b1db` | `db47b1db` |
...
| `admin.js` | `87433101` | `0cf87ca6` ← Session 6 |
| `import.js` | `763624ee` | `763624ee` |
| `firebase.js` | `889e8119` | `889e8119` |
...
*Konsolidováno: 2026-05-14 | Doplněno z Milan merge S1-6: 2026-05-15 | Sessions: 1 → 7.1 | Poslední update: Session 7.0 + 7.1, 2026-04-30 | Autor: Milan Migdal*

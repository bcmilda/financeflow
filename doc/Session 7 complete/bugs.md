...
> **Aplikované patche Session 7:** sekce bugs ze souboru `patch-session7-COMBINED(1).md` – Session 7.0 (2026-04-25) + Session 7.1 (2026-04-30)
...
|---|---|---|
| 🔴 Kritické | 2 | **PDF import – chybějící transakce + crash** (S7.1 reopen OPEN-003), **Bubble chart – bubliny pod lištu** (OPEN-027) |
...
**Nově reopened Session 7.1 (2026-05-19):** OPEN-003 PDF crash + chybějící transakce
...
### OPEN-003 · PDF import – token limit **(Session 2 → Session 7.0 částečně → Session 7.1 reopen)**
...
- **Priorita:** 🔴 Kritická – základní funkce importu nefunkční
- **Co testovat:** Import PDF s přesně známým počtem transakcí → ověřit počet → kliknout "Přidat a editovat" → ověřit reakci
- **Souvisí s OPEN-004** ze Session 1 (jiný limit – Worker size)
- **🔗 Cross-reference:** FIX-052, ADR-032, `todo.md` TODO-005, `architecture.md` sekce 17
...
### OPEN-026 · Import preview crash při 0 transakcích **(Session 7.0)**
- **Sekce:** Import dat
- **Soubor:** `import.js`
...
- **Root cause:** `showImportPreview()` nepočítá s prázdným polem transakcí → dereference `undefined`
- **Reprodukce:** Importovat PDF výpis který byl již dříve importován → všechny transakce jsou duplicity → crash
- **Priorita:** Střední
- **🔗 Cross-reference:** TODO-065, `architecture.md` sekce 17 (PDF import systém)

### OPEN-027 · Bubble chart – bubliny zasahují pod přepínací lištu **(Session 7.1, potvrzeno 2026-05-19)**
...
*Konsolidováno: 2026-04-23 | Doplněno z bugs_consolidated_s5: 2026-05-15 | Session 7.0+7.1 patch: 2026-05-15 | Sessions: 1 → 7.1 | Autor: Milan Migdal*

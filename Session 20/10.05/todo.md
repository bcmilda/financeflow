...
- **TODO-234 · Onboarding.** Krok 1 dle Milana: jazyk, výchozí měna, typ platby,
  typ peněženky, formát data, **frekvence výplaty + den v měsíci**, dotaz na
  půjčku/hypotéku (ano/ne → odemkne S2 ve skóre). Vše s možností „nastavit později".

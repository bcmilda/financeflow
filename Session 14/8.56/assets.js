//  FinanceFlow · v8.56 · assets.js · 2026-06-29
// ══════════════════════════════════════════════════════
    ...
    if(isWallets){
      ...
      html += ws.map(w=>{
        ...
        return `<div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;padding:9px 12px;margin-bottom:6px;display:flex;align-items:center;gap:10px">
          ...
          <span style="font-weight:600;font-variant-numeric:tabular-nums;color:${balCZK>=0?'#60a5fa':'var(--expense)'};white-space:nowrap;min-width:160px;text-align:right;flex-shrink:0">${fmtP(balCZK)} Kč</span>
        </div>`;

  ...
  try{
    ...
    el.innerHTML=`<div style="background:var(--surface2);border-radius:10px;padding:12px;border:1px solid var(--border)">
      ...
      ${j.coicop?`<div style="display:flex;align-items:center;gap:7px;font-size:.74rem;color:#a8aec8;margin-bottom:10px">
        <span style="display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:${(typeof COICOP_GROUPS_DEF!=='undefined'&&COICOP_GROUPS_DEF.find(g=>g.id===j.coicop))?.color||'#aaa'};color:#000;font-size:.6rem;font-weight:800;flex-shrink:0">${j.coicop}</span>

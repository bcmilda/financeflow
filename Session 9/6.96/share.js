...
async function renderShareSection() {
  ...
  el.innerHTML = `
    ...
    <!-- Primární akce: nativní share sheet (mobil) -->
    <button class="btn btn-accent" onclick="shareVia('native')" style="width:100%;display:flex;align-items:center;justify-content:center;gap:10px;font-size:.95rem;padding:13px;margin-bottom:12px;border-radius:12px">
      <span style="font-size:1.3rem">📤</span>
      <div style="text-align:left">
        <div style="font-weight:700">Sdílet s přáteli</div>
        <div style="font-size:.72rem;opacity:.8">WhatsApp · Messenger · Signal · Email · SMS · a další</div>
      </div>
    </button>

    <!-- Přímé kanály -->
    <div style="font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:var(--text3);margin-bottom:8px">Nebo vybrat kanál přímo</div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:12px">
      <button class="btn" onclick="shareVia('whatsapp')" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:12px 6px;border-radius:12px">
        <span style="font-size:1.6rem">💬</span>
        <span style="font-size:.72rem;font-weight:600">WhatsApp</span>
      </button>
      <button class="btn" onclick="shareVia('signal')" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:12px 6px;border-radius:12px">
        <span style="font-size:1.6rem">🔵</span>
        <span style="font-size:.72rem;font-weight:600">Signal</span>
      </button>
      <button class="btn" onclick="shareVia('telegram')" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:12px 6px;border-radius:12px">
        <span style="font-size:1.6rem">✈️</span>
        <span style="font-size:.72rem;font-weight:600">Telegram</span>
      </button>
      <button class="btn" onclick="shareVia('messenger')" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:12px 6px;border-radius:12px">
        <span style="font-size:1.6rem">💙</span>
        <span style="font-size:.72rem;font-weight:600">Messenger</span>
      </button>
      <button class="btn" onclick="shareVia('email')" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:12px 6px;border-radius:12px">
        <span style="font-size:1.6rem">📧</span>
        <span style="font-size:.72rem;font-weight:600">Email</span>
      </button>
      <button class="btn" onclick="shareVia('sms')" style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px;padding:12px 6px;border-radius:12px">
        <span style="font-size:1.6rem">💬</span>
        <span style="font-size:.72rem;font-weight:600">SMS</span>
      </button>
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px">
      <button class="btn" onclick="shareVia('qr')" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:10px">
        <span style="font-size:1.2rem">📱</span>
        <span style="font-size:.8rem;font-weight:600">QR kód</span>
      </button>
      <button class="btn" onclick="copyShareLink()" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:10px">
        <span style="font-size:1.2rem">📋</span>
        <span style="font-size:.8rem;font-weight:600">Kopírovat odkaz</span>
      </button>
    </div>

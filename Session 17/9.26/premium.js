// FinanceFlow · v9.26 · premium.js · 2026-07-27
//  PREMIUM SYSTEM
// ══════════════════════════════════════════════════════
...
function goPremium() {
  // S17.26 (TODO-153): Stripe je nasazený – nabídni volbu měsíčně/ročně a otevři checkout.
  // startPremiumSubscription (donate.js) samo ošetří chybějící Payment Link URL (zatím
  // REPLACE_ME), takže dokud Milan nevloží skutečné odkazy, uživatel dostane srozumitelnou
  // hlášku místo tichého selhání.
  ...
  const yearly = confirm('Chceš roční členství (2 měsíce zdarma)?\n\nOK = ročně, Storno = měsíčně');
